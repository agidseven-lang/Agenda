...
import { registerNativeShareIpc } from "./nativeshare"; // F3.3.74C — Windows Share nativo (pacote único imagem+legenda+link)
...
app.whenReady().then(() => {
  ...
  registerNativeShareIpc(); // F3.3.74C — native-share (DataPackage unico via helper; eventos sanitizados)
