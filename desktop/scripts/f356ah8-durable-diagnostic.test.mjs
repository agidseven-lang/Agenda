...
ok('A0.1 package.json 1.0.242', PKG.version === '1.0.242');
...
ok('A5.2 contém os campos-chave da falha', /stage=http_error/.test(txt) && /httpStatus=500/.test(txt) && /workerCode=commit_failed/.test(txt) && /appVersion=1\.0\.242/.test(txt));
