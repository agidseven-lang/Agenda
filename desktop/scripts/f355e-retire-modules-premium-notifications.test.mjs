...
/* ============ A. VERSÃO ============ */
ok('A1 package version 1.0.240 (RE-PINADO F3.5.6A-H2)', /"version":\s*"1\.0\.240"/.test(PKG));
ok('A2 lock version 1.0.240 (2x) (RE-PINADO F3.5.6A-H2)', (LOCK.match(/"version":\s*"1\.0\.240"/g) || []).length >= 2);
