...
/* ============ A. VERSÃO ============ */
ok('A1 package version 1.0.237 (RE-PINADO F3.5.6A-H2)', /"version":\s*"1\.0\.237"/.test(PKG));
ok('A2 lock version 1.0.237 (2x) (RE-PINADO F3.5.6A-H2)', (LOCK.match(/"version":\s*"1\.0\.237"/g) || []).length >= 2);
