...
/* ───────────── A. IDENTIDADE ───────────── */
ok("A1 versão 1.0.229 (RE-PINADO F3.5.6A)", pkg.version === "1.0.229", pkg.version);
...
if (fs.existsSync(P.lock)) {
  ...
  ok("A3 lock 1.0.229 ×2 (RE-PINADO F3.5.6A)", lock.version === "1.0.229" && lock.packages[""].version === "1.0.229");
