...
/* ───────────── A. IDENTIDADE ───────────── */
ok("A1 versão 1.0.232 (RE-PINADO F3.5.6A-H2)", pkg.version === "1.0.232", pkg.version);
...
if (fs.existsSync(P.lock)) {
  ...
  ok("A3 lock 1.0.232 ×2 (RE-PINADO F3.5.6A-H2)", lock.version === "1.0.232" && lock.packages[""].version === "1.0.232");
