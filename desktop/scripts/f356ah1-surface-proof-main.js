...
app.whenReady().then(async () => {
  ...
  rec("R00 corpos REAIS extraídos do dist 1.0.233 (deliver/handoff/bring/windowActive/collect/aceite) + classify real",
  ...
  const ctx = {
    ...
    notifTele: {}, groupTele: { updates: 0, opens: 0 }, app: { getVersion: () => "1.0.233" },
    electron_1: { app: { getVersion: () => "1.0.233" } },
