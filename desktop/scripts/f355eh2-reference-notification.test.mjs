...
/* ============ A. IDENTIDADE (RE-PINADO F3.5.6A-H1: candidata 1.0.230; contrato VISUAL da referência CONGELADO) ============ */
console.log('— A) identidade da candidata —');
ok('A1 package.json 1.0.230 (RE-PINADO F3.5.6A-H1)', /"version":\s*"1\.0\.230"/.test(PKG));
...
ok('A3 package-lock 1.0.230 (2x — RE-PINADO F3.5.6A-H1)', (LOCK.match(/"version":\s*"1\.0\.230"/g) || []).length >= 2);
