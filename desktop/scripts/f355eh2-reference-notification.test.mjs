...
/* ============ A. IDENTIDADE (RE-PINADO F3.5.5E-H4: candidata 1.0.228; contrato VISUAL da referência CONGELADO) ============ */
console.log('— A) identidade da candidata —');
ok('A1 package.json 1.0.228 (RE-PINADO F3.5.5E-H4)', /"version":\s*"1\.0\.228"/.test(PKG));
...
ok('A3 package-lock 1.0.228 (2x — RE-PINADO F3.5.5E-H4)', (LOCK.match(/"version":\s*"1\.0\.228"/g) || []).length >= 2);
