...
/* ============ A. IDENTIDADE (RE-PINADO F3.5.6A-H2: candidata 1.0.242; contrato VISUAL da referência CONGELADO) ============ */
console.log('— A) identidade da candidata —');
ok('A1 package.json 1.0.242 (RE-PINADO F3.5.6A-H2)', /"version":\s*"1\.0\.242"/.test(PKG));
...
ok('A3 package-lock 1.0.242 (2x — RE-PINADO F3.5.6A-H2)', (LOCK.match(/"version":\s*"1\.0\.242"/g) || []).length >= 2);
