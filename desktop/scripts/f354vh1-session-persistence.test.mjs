...
// [ATUALIZADA F3.5.4W-H2] na 1.0.216 (hotfix do som das notificações imediatas — bgnotify/renderer/obs; auth intocada).
// A versão do pacote agora é 1.0.216.
ok('39 versão 1.0.216 no package.json (persistência 1.0.213 preservada)', JSON.parse(fs.readFileSync(path.resolve(__dirname,'..','package.json'),'utf8')).version==='1.0.216');
