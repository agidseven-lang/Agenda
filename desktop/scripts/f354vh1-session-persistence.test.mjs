...
// [ATUALIZADA F3.5.4W] O contrato de persistência/máquina de estados de auth (1.0.213) é PRESERVADO
// na 1.0.214 (fase de cards/detalhes/quadros — só o renderer muda). A versão do pacote agora é 1.0.214.
ok('39 versão 1.0.214 no package.json (persistência 1.0.213 preservada)', JSON.parse(fs.readFileSync(path.resolve(__dirname,'..','package.json'),'utf8')).version==='1.0.214');
