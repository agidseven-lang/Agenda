...
// A versão do pacote agora é 1.0.225 (RE-PINADO F3.5.5E-H1 — redesign visual das notificações; máquina de estados intacta).
ok('39 versão 1.0.225 no package.json (persistência 1.0.213 preservada — RE-PINADO F3.5.5E-H1)', JSON.parse(fs.readFileSync(path.resolve(__dirname,'..','package.json'),'utf8')).version==='1.0.225');
