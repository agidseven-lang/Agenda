...
// [ATUALIZADA F3.5.5A-H1] na 1.0.218 (observações internas por tema — só renderer index.html; auth intocada).
// A versão do pacote agora é 1.0.218.
ok('39 versão 1.0.218 no package.json (persistência 1.0.213 preservada)', JSON.parse(fs.readFileSync(path.resolve(__dirname,'..','package.json'),'utf8')).version==='1.0.218');
