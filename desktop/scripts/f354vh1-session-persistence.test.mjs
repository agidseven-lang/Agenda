...
// na 1.0.215 (fase de detalhes/status/observações — renderer + IPC de clipboard; auth intocada).
// A versão do pacote agora é 1.0.215.
ok('39 versão 1.0.215 no package.json (persistência 1.0.213 preservada)', JSON.parse(fs.readFileSync(path.resolve(__dirname,'..','package.json'),'utf8')).version==='1.0.215');
