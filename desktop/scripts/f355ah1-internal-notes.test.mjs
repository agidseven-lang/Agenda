...
ok('A1 package.json 1.0.227 (RE-PINADO F3.5.5E-H3; base traz as observações internas)', pkg.version === '1.0.227' && /custom-script-quantity-rich-editor/.test(pkg.description || ''));
