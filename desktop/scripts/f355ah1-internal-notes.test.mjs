...
ok('A1 package.json 1.0.228 (RE-PINADO F3.5.5E-H4; base traz as observações internas)', pkg.version === '1.0.228' && /custom-script-quantity-rich-editor/.test(pkg.description || ''));
