...
ok('A1 package.json 1.0.230 (RE-PINADO F3.5.6A-H1; base traz as observações internas)', pkg.version === '1.0.230' && /custom-script-quantity-rich-editor/.test(pkg.description || ''));
