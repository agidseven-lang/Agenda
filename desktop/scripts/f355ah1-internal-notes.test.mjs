...
ok('A1 package.json 1.0.229 (RE-PINADO F3.5.6A; base traz as observações internas)', pkg.version === '1.0.229' && /custom-script-quantity-rich-editor/.test(pkg.description || ''));
