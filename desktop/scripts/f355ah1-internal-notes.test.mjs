...
ok('A1 package.json 1.0.239 (RE-PINADO F3.5.6A-H2; base traz as observações internas)', pkg.version === '1.0.239' && /custom-script-quantity-rich-editor/.test(pkg.description || ''));
