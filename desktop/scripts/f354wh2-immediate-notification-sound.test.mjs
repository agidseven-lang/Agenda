...
ok('package.json version 1.0.216', pkg.version === '1.0.216');
ok('description da candidata (immediate-notification-sound)', /1\.0\.216-immediate-notification-sound/.test(pkg.description || ''));
