...
ok('A1 package.json 1.0.227 (RE-PINADO F3.5.5E-H3; base traz a Agenda Premium)', pkg.version === '1.0.227' && /custom-script-quantity-rich-editor/.test(pkg.description || ''));
ok('A2 package-lock 1.0.227 (RE-PINADO F3.5.5E-H3)', JSON.parse(R('package-lock.json')).version === '1.0.227');
ok('A3 lock packages[""] 1.0.227 (RE-PINADO F3.5.5E-H3)', JSON.parse(R('package-lock.json')).packages[''].version === '1.0.227');
