...
ok('A1 package.json 1.0.221 (pin F3.5.5C-H1; base traz a Agenda Premium)', pkg.version === '1.0.221' && /custom-script-quantity-rich-editor/.test(pkg.description || ''));
ok('A2 package-lock 1.0.221', JSON.parse(R('package-lock.json')).version === '1.0.221');
ok('A3 lock packages[""] 1.0.221', JSON.parse(R('package-lock.json')).packages[''].version === '1.0.221');
