// F3.5.5A — INTEGRAÇÃO renderer/main (versão 1.0.219 — pin atualizado pela F3.5.5B; deadlineVersion autoritativo; Detalhes;
...
ok('A1 package.json 1.0.219 + description da candidata', pkg.version === '1.0.219' && /premium-agenda-redesign/.test(pkg.description || ''));
