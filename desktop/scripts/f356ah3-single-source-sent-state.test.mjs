 ...
 * e passa em 1.0.245; mantém a PARIDADE renderer×main (slaRules) e a NEUTRALIDADE da camada de
...
/* ---------- A. IDENTIDADE / VERSÃO ---------- */
ok('A1 package.json 1.0.245', PKG.version === '1.0.245');
ok('A2 package-lock 1.0.245 (raiz + packages[""])', LOCK.version === '1.0.245' && LOCK.packages[''].version === '1.0.245');
