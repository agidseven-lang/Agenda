 ...
 *
 * Correção 1.0.240 (RENDERER-only, index.html):
...
ok('S17 package.json = 1.0.240 + marcador H13', PKG.version === '1.0.240' && /f356ah13-timeline-honest-preenvio/.test(PKG.description || ''));
