 ...
 *
 * Correção 1.0.241 (RENDERER-only, index.html):
...
ok('S17 package.json = 1.0.241 + marcador H13', PKG.version === '1.0.241' && /f356ah13-timeline-honest-preenvio/.test(PKG.description || ''));
