...
function authorized(rel) {
  ...
  // F3.4.6 — hotfix visual da grade diária: testes/fixtures/QA-visual próprios (fonte gateada
  // byte-a-byte pelo delta AUTORIZADO em f346-hotfix-region-invariance.test.mjs @11520f5).
