 ...
 *
 * Correção 1.0.246 (RENDERER-only, index.html, TEXTUAL — 1 linha; SEM mudar condição/lógica):
...
/* =========================== IDENTIDADE =========================== */
ok('ID1 package.json = 1.0.246 + marcador H15', PKG.version === '1.0.246' && /nextaction-final-wait-text/.test(PKG.description || ''));
