 ...
 *
 * Correção 1.0.241 (RENDERER-only, index.html, ESPECÍFICA — sem clamp geral):
...
// identidade
ok('S17 package.json = 1.0.241 + marcador H14', PKG.version === '1.0.241' && /timeline-step7-final-wait/.test(PKG.description || ''));
ok('S18 package-lock 1.0.241 (raiz + packages[""])', LOCK.version === '1.0.241' && LOCK.packages[''].version === '1.0.241');
