...
ok('A1 package.json 1.0.227 + marcador custom-cronograma-quantity-universal-paste (RE-PINADO F3.5.5E-H3)', pkg.version === '1.0.227' && /custom-cronograma-quantity-universal-paste/.test(pkg.description || ''));
...
ok('A3 package-lock 1.0.227 (raiz + packages[""] — RE-PINADO F3.5.5E-H3)', JSON.parse(R('package-lock.json')).version === '1.0.227' && JSON.parse(R('package-lock.json')).packages[''].version === '1.0.227');
