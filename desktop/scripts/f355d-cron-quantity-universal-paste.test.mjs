...
ok('A1 package.json 1.0.225 + marcador custom-cronograma-quantity-universal-paste (RE-PINADO F3.5.5E-H1)', pkg.version === '1.0.225' && /custom-cronograma-quantity-universal-paste/.test(pkg.description || ''));
...
ok('A3 package-lock 1.0.225 (raiz + packages[""] — RE-PINADO F3.5.5E-H1)', JSON.parse(R('package-lock.json')).version === '1.0.225' && JSON.parse(R('package-lock.json')).packages[''].version === '1.0.225');
