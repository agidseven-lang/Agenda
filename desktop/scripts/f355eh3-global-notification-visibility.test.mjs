...
// ───────────────────────── A. IDENTIDADE ─────────────────────────
ok("A1 versão 1.0.237 (RE-PINADO F3.5.6A-H2)", pkg.version === "1.0.237", pkg.version);
...
if (fs.existsSync(P.lock)) {
  ...
  ok("A3 lock 1.0.237 ×2 (RE-PINADO F3.5.6A-H2)", lock.version === "1.0.237" && lock.packages[""].version === "1.0.237");
