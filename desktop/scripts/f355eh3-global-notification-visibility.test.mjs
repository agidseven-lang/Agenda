...
// ───────────────────────── A. IDENTIDADE ─────────────────────────
ok("A1 versão 1.0.230 (RE-PINADO F3.5.6A-H1)", pkg.version === "1.0.230", pkg.version);
...
if (fs.existsSync(P.lock)) {
  ...
  ok("A3 lock 1.0.230 ×2 (RE-PINADO F3.5.6A-H1)", lock.version === "1.0.230" && lock.packages[""].version === "1.0.230");
