/* ============================================================================
   ID Seven — Cloudflare Worker  [V64.27-aurora-card]
   ============================================================================
...
// V64.22 — META OG/Twitter premium COMPARTILHADA por TODAS as páginas do cliente
// (renderClientHtml/Success/PhaseAck/Error). Assim o card do WhatsApp mostra SEMPRE o
// banner premium 1200×630 — em qualquer estado do link (inclusive "não encontrado").
// - og:image ABSOLUTO no domínio servido (premium primário; workers.dev como fallback);
// - cache-busting ?v=OG_IMG_VER força o WhatsApp/Facebook a rebaixar a arte nova
//   (o roteamento usa só url.pathname, então a querystring não afeta a rota da imagem);
// - inclui og:image:secure_url + type + width/height + twitter summary_large_image.
...
/* F3.3.73I6C18E — imagem OG EXCLUSIVA do Roteiro (rota versionada própria, sem
   querystring, mesma convenção). O Cronograma permanece byte-exato na arte
   v64-39; o Roteiro NUNCA mais compartilha a arte que diz "Aprovar cronograma"
   — a dele mostra visualmente "Roteiro de gravação de vídeos". URL distinta
   por tipo também evita reuso de thumbnail cacheada por URL no WhatsApp. */
const OG_IMG_PATH_ROTEIRO = "/og/wa-card-roteiro-v64-60.jpg";   // F3.3.73I6C18G — arte com a LOGO OFICIAL; rota versionada nova força re-download no WhatsApp
...
function ogClientMeta(origin, titleRaw, descRaw, pathRel, altRaw, imgPathRel) {
  ...
  // F3.3.73I6C18E — imagem por TIPO; ausente => OG_IMG_PATH (cronograma, EXATO de antes)
  const img = base + (imgPathRel || OG_IMG_PATH);
...
function crawlerCardHtml(origin, clientName, token, ptype) {
  ...
  return '<!doctype html>\n<html lang="pt-BR"><head>\n<meta charset="utf-8"/>\n' +
    ogClientMeta(origin, title, desc, "/cliente/cronograma/" + token, pt.imgAlt, pt.imgPath) +
...
function shareUnavailableHtml(origin, state) {
  ...
  return '<!doctype html>\n<html lang="pt-BR"><head>\n<meta charset="utf-8"/>\n' +
    ...
    '<meta name="viewport" content="width=device-width, initial-scale=1"/>\n' +
    '<title>' + titulo + ' — Agenda ID Seven</title>\n' +
    '</head><body style="margin:0;background:#070810;color:#e9edef;font-family:system-ui,Segoe UI,Roboto,Arial,sans-serif">\n' +
    '<div style="max-width:520px;margin:0 auto;padding:52px 22px;text-align:center">\n' +
...
// V64.20 — banner premium 1200x630 do link (PNG estatico pre-renderizado, embutido).
const OG_BANNER_B64="";
const OG_JPG_B64="";  // V64.24 canario JPEG 1200x630 (image/jpeg)
// F3.3.73I6C18E — arte OG EXCLUSIVA do Roteiro (1200×630 JPEG, embutida como as demais):
// texto visual dominante "Roteiro de gravação de vídeos" + selo "APROVAÇÃO DE ROTEIRO"
// (mesmo estilo premium da arte v64-39 do Cronograma, que permanece intocada).
// F3.3.73I6C18G — canto superior esquerdo usa a LOGO OFICIAL (brand/logo-source.png).
function jpgRoteiroBannerResponse(method) {
  const bin = atob(OG_JPG_ROTEIRO_B64);
  ...
  // HEAD: mesmos headers, sem corpo (paridade com jpgBannerResponse).
  return new Response(method === "HEAD" ? null : bytes, { status: 200, headers });
}
const OG_JPG_ROTEIRO_B64="";   // 1200x630 image/jpeg (Roteiro; C18G: logo OFICIAL ID Seven de brand/logo-source.png)
...
export default {
  async fetch(request, env, ctx) {
    ...
    if (request.method === "GET" || request.method === "HEAD") {
      ...
      if (url.pathname === "/og/wa-card-roteiro-v64-60.jpg" || url.pathname === "/og/wa-card-roteiro-v64-59.jpg") return jpgRoteiroBannerResponse(M);   // F3.3.73I6C18E/C18G (v64-59 = alias p/ HTML cacheado)
      if (url.pathname === "/og/wa-card-v64-24.jpg" || url.pathname === "/og/wa-card-v64-25-a.jpg" || url.pathname === "/og/wa-card-v64-25-b.jpg" || url.pathname === "/preview.jpg" || url.pathname === "/og/wa-card-v64-26.jpg" || url.pathname === "/og/wa-card-v64-38.jpg" || url.pathname === "/og/wa-card-v64-39.jpg") return jpgBannerResponse(M);
    }

    // V64.20/23 — banner premium 1200×630 do link (cartão grande no WhatsApp). PNG estático
    // embutido (sem deps/wasm), cache 24h. Aceita a rota legada /og/aprovar.png E as rotas
    // VERSIONADAS sem querystring (/og/aprovar-v64-23.png, etc.) usadas no og:image.
    if (request.method === "GET" && /^\/og\/aprovar(-v[0-9.\-]+)?\.png$/.test(url.pathname)) {
    ...
    // - POST .../action → grava clientLastAction (CAMPO NOVO ADITIVO, sem alterar schema).
    {
      ...
      if (cronoMatch && request.method === "GET") {
        // V64.23 — crawlers de preview (WhatsApp/Facebook/Twitter/Telegram/LinkedIn) recebem
        // um HTML MÍNIMO com OG no topo (sem o portal pesado). Navegador normal recebe o portal.
        if (isCrawlerUA(request.headers.get("user-agent"))) {
          return handleClientCronogramaCrawler(cronoMatch[1], env, url.origin);
        }
...
/* ───────── BANNER OG (premium, estático) — cartão grande do link no WhatsApp ───────── */
function ogBannerResponse() {
  const bin = atob(OG_BANNER_B64);
  const bytes = new Uint8Array(bin.length);
  for (let i = 0; i < bin.length; i++) bytes[i] = bin.charCodeAt(i);
...
// detecção de crawler, sem CSS/JS). OG no topo absoluto do <head>. Serve para descobrir se
// o problema do preview é o cronograma/token (não é, se ESTE renderizar no WhatsApp).
function waCardTestHtml(method) {
  const html = '<!doctype html>\n<html lang="pt-BR">\n<head>\n<meta charset="utf-8">\n' +
    '<meta property="og:type" content="website">\n' +
    '<meta property="og:site_name" content="Agenda ID Seven">\n' +
    '<meta property="og:title" content="Aprovar cronograma — Teste Premium">\n' +
    '<meta property="og:description" content="Revise e aprove seu cronograma em uma área segura da Agenda ID Seven.">\n' +
    '<meta property="og:url" content="https://aprovar.agendaidseven.com.br/wa-card-test-v64-24">\n' +
    '<meta property="og:image" content="https://aprovar.agendaidseven.com.br/og/wa-card-v64-24.jpg">\n' +
    '<meta property="og:image:url" content="https://aprovar.agendaidseven.com.br/og/wa-card-v64-24.jpg">\n' +
    '<meta property="og:image:secure_url" content="https://aprovar.agendaidseven.com.br/og/wa-card-v64-24.jpg">\n' +
    '<meta property="og:image:type" content="image/jpeg">\n' +
    '<meta property="og:image:width" content="1200">\n' +
    '<meta property="og:image:height" content="630">\n' +
    '<meta name="twitter:card" content="summary_large_image">\n' +
    '<meta name="twitter:title" content="Aprovar cronograma — Teste Premium">\n' +
    '<meta name="twitter:description" content="Revise e aprove seu cronograma em uma área segura da Agenda ID Seven.">\n' +
    '<meta name="twitter:image" content="https://aprovar.agendaidseven.com.br/og/wa-card-v64-24.jpg">\n' +
    '<title>Aprovar cronograma — Teste Premium</title>\n</head>\n<body>\n' +
    '<a href="https://aprovar.agendaidseven.com.br/wa-card-test-v64-24">Abrir aprovação</a>\n' +
    '</body>\n</html>';
...
// V64.23 — resposta dedicada a CRAWLERS de preview. HTML mínimo (só OG + corpo simples),
// sempre HTTP 200, text/html, Cache-Control de preview. Best-effort: lê o nome do cliente
// para o título; se o token não existir, ainda devolve o card premium genérico (nunca 404
...
async function handleClientCronogramaView(token, env, origin) {
  try {
    if (!token) return htmlResponse(renderClientErrorHtml("Link inválido", "O link não contém um token válido.", origin), 400);
    let accessToken;
    // Mesmo escopo usado pelo CRON p/ ler Firestore (comprovadamente funcional).
    try { accessToken = await getAccessToken(env, FCM_SCOPE + " " + DATASTORE_SCOPE); }
    catch (e) {
      console.error("[CLIENT-VIEW] auth falhou:", e && e.message);
      return htmlResponse(renderClientErrorHtml("Indisponível", "Não foi possível carregar agora. Tente novamente em instantes.", origin), 503);
    }
    const task = await queryTaskByToken(env, accessToken, token);
    if (!task) {
    ...
    return htmlResponse(renderClientErrorHtml("Algo deu errado",
      "Tivemos um problema ao montar sua página. Tente novamente em instantes ou fale com a equipe ID Seven.", origin), 500);
  }
}
...
function htmlResponseCacheable(html, status) {
  ...
  // Content-Type explicito. Usada pela rota canonica /share/cronograma (preview WhatsApp Business).
...
function frequencyLabel(t, ptype) {
  ...
  // F3.5.5C — quantidade PERSONALIZADA (Desktop 1.0.220+): cronSub "q<N>" p/ qualquer
  // N≥1 ⇒ rótulo "<N> roteiros" (q4/q6/q8/q12 produzem EXATAMENTE o texto do mapa antigo).
  if (ptype && ptype.key === "roteiro") {
    const q = (t.cronSub || t.subtype || "").toString().toLowerCase();
    const mq = /^q([1-9]\d{0,2})$/.exec(q);
    if (mq) return mq[1] + " roteiro" + (mq[1] === "1" ? "" : "s");
    return "Roteiro";
  }
...
ogClientMeta(origin, pt.aprLabel + " — " + (task.client || "Cliente"), pt.ackOgDesc, "/cliente/cronograma/" + token, pt.imgAlt, pt.imgPath) +
...
ogClientMeta(origin, ogTitleRaw, ogDescRaw, "/cliente/cronograma/" + token, pt.imgAlt, pt.imgPath) +
...
function renderClientErrorHtml(title, msg, origin) {
  const t = escapeHtml(title), m = escapeHtml(msg);
  // V64.22 — mesmo card premium (banner 1200×630) também na página de erro/404, para que o
  // preview do WhatsApp NUNCA caia em "preview cru" mesmo quando o link ainda não resolve.
  return '<!doctype html>\n<html lang="pt-BR"><head>\n' +
'<meta charset="utf-8"/>\n<meta name="viewport" content="width=device-width, initial-scale=1"/>\n' +
ogClientMeta(origin, "Aprovar cronograma — Agenda ID Seven", "Sua área de aprovação de cronograma. Link seguro · Agenda ID Seven.", "/") +
...
function renderClientSuccessHtml(task, token, origin) {
  ...
  return '<!doctype html>\n<html lang="pt-BR"><head>\n' +
'<meta charset="utf-8"/>\n<meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover"/>\n' +
ogClientMeta(origin, pt.aprLabel + " — " + (task.client || "Cliente"), pt.successOgDesc, "/cliente/cronograma/" + token, pt.imgAlt, pt.imgPath) +
