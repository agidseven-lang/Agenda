...
check('C_HEALTH_V64_52', 'Healthcheck retorna V64.59 (linha canônica; sufixo da fase atual)', /version: "V64\.59-c23-share-snapshot"/.test(SRC));
...
(async function partE(){
  ...
  check('F_VERSION','Healthcheck = V64.59 (linha canônica; sufixo da fase atual)', /version: "V64\.59-c23-share-snapshot"/.test(SRC));
